...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Find the first separator from remaining_separators that appears in current_text
        chosen_idx = None
        ...
        separator = remaining_separators[chosen_idx]
        next_separators = remaining_separators[chosen_idx + 1 :]
        ...
        for piece in splits:
            ...
            if len(piece) <= self.chunk_size:
                ...
                if next_separators:
                    good_splits.extend(self._split(piece, next_separators))
                else:
                    good_splits.extend(
        ...
        # Merge pieces back with separator up to chunk_size
        merged: list[str] = []
        ...
        for piece in good_splits:
            ...
            elif current_len + sep_len + piece_len <= self.chunk_size:
                current_chunk.append(piece)
